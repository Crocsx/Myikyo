...
namespace HexasphereGrid_Demos
{
    public class Demo1 : MonoBehaviour
    {
        ...
        [Tooltip("Sample material used to render a transparent arrow on top of a tile.")]
        ...
        void Start()
        {
            ...
            hexa.OnDragStart += (hexa) => Debug.Log("Drag starts");
            hexa.OnDragEnd += (hexa) => Debug.Log("Drag ends");
            hexa.OnFlyEnd += (hexa) => Debug.Log("Fly ends");
            hexa.OnFlyStart += (hexa) => Debug.Log("Fly starts");

            // Color North in red
            int ti = hexa.GetTileAtPosition(new Vector3(0, 50, 55));
            ...
            ti = hexa.GetTileAtPosition(new Vector3(0, 0, 5));
        ...
        void Update()
        {
            ...
            hexa.SetTileTextureRotation(ARROW_TILE_INDEX, Mathf.Deg2Rad * angle);
        }
